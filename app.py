...
ACHIEVEMENTS = [
    {
        "title": "Outstanding grade — Data Science Internship",
        "detail": "IDEAS-TIH, Indian Statistical Institute Kolkata.",
    },
    {
    ...
    {
        "title": "Smart India Hackathon (SIH26001)",
        "detail": "Building TerraWatch, a landslide early-warning system prototype.",
    },
]
...
def activities():
    return render_template("activities.html", profile=PROFILE, activities=ACTIVITIES)
